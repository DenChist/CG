...
int main()
{
    ...
    cout << ">> ambient light [0.0, 1.0]: ";
    cin >> AmbStren;
    cout << ">> diffusion light [0.0, 1.0]: ";
    cin >> DifStren;
    cout << ">> specular light [0.0, 1.0]: ";
    cin >> SpecStren;
    cout << ">> approximation [less then 1.0]: ";
    cin >> APPROX;
    cout << "\n Success" << endl;
    cout << "Start" << endl;
    // Init GLFW
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "lab4-5", nullptr, nullptr);
